...
import s from './PersonalDataBlockUserForm.module.css';
import { tr } from './PersonalDataBlockUserForm.i18n';

interface PersonalDataBlockUserFormProps {
    className: string;
    id: string;
    onIsLoginUniqueChange?: (arg: string) => void;
}

export const PersonalDataBlockUserForm = ({ className, id, onIsLoginUniqueChange }: PersonalDataBlockUserFormProps) => {
    const {
        register,
        setValue,
        getValues,
    ...
    console.log('persdata', dirtyFields);
