...
import s from './TeamBlockUserForm.module.css';
import { tr } from './TeamBlockUserForm.i18n';

interface TeamBlockUserFormProps {
    className: string;
    id: string;
}

export const TeamBlockUserForm = ({ className, id }: TeamBlockUserFormProps) => {
    const {
        setValue,
        trigger,
        watch,
        ...
        <div className={className} id={id}>
            ...
            <div className={s.ThreeInputsRow}>
                <FormControl label="Buddy">
                    <UserSelect
                        mode="single"
                        selectedUsers={watch('buddyId') ? [watch('buddyId')] : undefined}
