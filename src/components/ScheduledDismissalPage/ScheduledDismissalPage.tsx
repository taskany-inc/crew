...
export const ScheduledDismissalPage = ({
    ...
    const orgMembership = user?.memberships.find((m) => m.group.organizational)?.group;
    ...
    const defaultValues: Partial<CreateScheduledDeactivation> = useMemo(
        () => ({
            ...
            organizationalGroup: scheduledDeactivation?.organizationalGroup || orgMembership?.name,
