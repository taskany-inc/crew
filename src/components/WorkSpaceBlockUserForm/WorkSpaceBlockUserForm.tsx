...
import s from './WorkSpaceBlockUserForm.module.css';
import { tr } from './WorkSpaceBlockUserForm.i18n';

interface WorkSpaceBlockUserFormProps {
    className: string;
    id: string;
}

export const WorkSpaceBlockUserForm = ({ className, id }: WorkSpaceBlockUserFormProps) => {
    const {
        register,
        setValue,
        trigger,
